...
export const sendForgotPasswordMail = async(req: Request, res: Response) => {
  const content = 'We have received a password reset request for your account. Kindly click the link below to proceed. If this isn\'t you, try changing your password or send an alert mail to delta@nitt.edu.';
